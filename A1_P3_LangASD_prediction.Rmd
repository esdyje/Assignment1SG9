...
Pred=predict(bestmodel, testdata, interval="predict")
round(Pred, digits = 3)
...
#Bernies MLU development
ggplot(Berniedata, aes(x = visit, y= CHI_MLU, colour = Diagnosis)) + geom_smooth() + geom_point()+ggtitle("Bernie's development across visits")
