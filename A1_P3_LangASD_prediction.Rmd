...
PredInt=merTools::predictInterval(merMod = bestmodel, newdata = testdata, 
...
dif_visit1 = Berniedata$CHI_MLU[Berniedata$visit==1] - TD_visit1 #0.64

# Visit 2
TD_visit2=myfunction(2, MMLUV2 ,VBIQ)
dif_visit2 = Berniedata$CHI_MLU[Berniedata$visit==2] - TD_visit2 #0.78

# Visit 3
TD_visit3=myfunction(3, MMLUV3 ,VBIQ)
dif_visit3 = Berniedata$CHI_MLU[Berniedata$visit==3] - TD_visit3 #1.23

# Visit 4
TD_visit4=myfunction(4, MMLUV4 ,VBIQ)
dif_visit4 = Berniedata$CHI_MLU[Berniedata$visit==4] - TD_visit4 #0.71

# Visit 5
TD_visit5=myfunction(5, MMLUV5 ,VBIQ)
dif_visit5 = Berniedata$CHI_MLU[Berniedata$visit==5] - TD_visit5 #0.36

# Visit 6
TD_visit6=myfunction(6, MMLUV6 ,VBIQ)
dif_visit6 = Berniedata$CHI_MLU[Berniedata$visit==6] - TD_visit6 #0.35  
...
ggplot(Bernie_comp, aes(x = Visits, y= MLU, colour = Category)) + geom_smooth() + geom_point()+ggtitle("Bernie's development compared to an estimation of average TD performance")
